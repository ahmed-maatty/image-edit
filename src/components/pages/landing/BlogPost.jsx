      ...
      <div className="hero">
        <div className="box">
          <div className="bx blog_post_hero_bx">
            <div>
              <h1 className="blog_post_title">Article name on two row</h1>
              <p className="learnTutorial">
                summery for the article and what we will learn from it{" "}
              </p>
            </div>
          </div>
      ...
      <section className="blog_post_section">
        <div className="box">
          <div className="blog_post_container">
            ...
            <p className="blog_post_text_headline">
            ...
            <p className="blog_post_text_headline">Section</p>
            <p className="blog_post_text">
              At vero eos et accusamus et iusto odio dignissimos ducimus qui
              blanditiis praesentium voluptatum deleniti atque corrupti quos
              dolores et quas molestias excepturi sint occaecati cupiditate non
